...
module Snowy
  ...
  class Canvas
    ...
    def export_to_png(io = "".b, level: Zlib::DEFAULT_COMPRESSION)
      ...
      colorbits = 8
      colortype = 3
      PNG::Chunk.pack_to(io, "IHDR", [width, height, colorbits, colortype, 0, 0, 0].pack("NNCCCCC"))

      ## PLTE
      plte = palette.reduce("".b) { |a, e|
        a << e.pack_rgb
      }
      PNG::Chunk.pack_to(io, "PLTE", plte)
      ...
      PNG::Chunk.pack_to(io, "tRNS", trns.pack("C*"))
      ...
      PNG::Chunk.pack_to(io, "iTXt", ["snowy", 0, 0, <<-'SNOWY'].pack("a*xCCxxa*"))
This image is generated by snowy <https://rubygems.org/gems/snowy>
      SNOWY
      PNG::Chunk.pack_to(io, "iTXt", ["LICENSING", 0, 0, <<-'LICENSING'].pack("a*xCCxxa*"))
...
See <https://creativecommons.org/publicdomain/zero/1.0/>
      ...
      PNG::Chunk.pack_to(io, "IDAT", Zlib.deflate(lines, level))

      PNG::Chunk.pack_to(io, "IEND", "")
